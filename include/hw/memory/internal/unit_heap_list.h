...
extern void  hwL_unit_heap_list_initialize(hwL_unit_heap_list_t* list, hwu32 unit_size, int unit_num);
...
extern void  hwL_unit_heap_list_grow(hwL_unit_heap_list_t* list, void* memory, hwu32 memory_size);
...
extern hwL_unit_heap_list_node_t* hwL_unit_heap_list_get_node_from_heap_memory(void* memory, hwu32 memory_size);
