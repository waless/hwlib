...
extern void  hwuL_unit_heap_list_initialize(hwuL_unit_heap_list_t* list, hwu32 unit_size, int unit_num);
...
extern void  hwuL_unit_heap_list_grow(hwuL_unit_heap_list_t* list, void* memory, hwu32 memory_size);
...
extern hwuL_unit_heap_list_node_t* hwuL_unit_heap_list_get_node_from_heap_memory(void* memory, hwu32 memory_size);
