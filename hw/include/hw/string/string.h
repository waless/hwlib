...
extern void hw_string_initialize(hw_string_t* state, char* buffer, hwu32 capacity);
...
extern hwu32 hw_string_get_length(const hw_string_t* state);
...
extern hwbool hw_string_append_char(hw_string_t* state, char c);
extern hwbool hw_string_append_string(hw_string_t* state, const hw_string_t* rhs);
extern hwbool hw_string_append_cstring(hw_string_t* state, const char* p);
extern hwbool hw_string_append_buffer(hw_string_t* state, const char* buffer, hwu32 size);
...
extern hwbool hw_string_rfind_char(hwu32* out_index, const hw_string_t* state, char c);
...
extern hwbool hw_string_replace_ext_string(hw_string_t* state, const hw_string_t* ext);
extern hwbool hw_string_replace_ext_cstring(hw_string_t* state, const char* ext);
extern hwbool hw_string_replace_ext_buffer(hw_string_t* state, const char* ext, hwu32 size);
