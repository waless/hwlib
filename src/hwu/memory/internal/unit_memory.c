...
void hwuL_unit_memory_initialize(void* memory, hwu32 unit_size, hwu32 unit_num, void* append_unit_memory)
{
	hwu32				i	  = 0;
...
hwu32 hwuL_unit_memory_calculate_need_size(hwu32 unit_size, hwu32 unit_num)
{
